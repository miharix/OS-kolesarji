...
$ZeZakljucenaKT=SQL_JePoligonZakljucen();
$zakluciKT=false;
...
echo "<!DOCTYPE html>\n<HTML>\n<HEAD>\n<title>Tekmovanje - Poligon A</title>\n";
...
echo '<div id="naslov">Poligon A</div>';

if(!$zakluciKT && !$ZeZakljucenaKT){

echo '<form action="poligonA.php" method="POST">';
...
$OvirePoligona=SQL_PoligonOvireImenaA();
...
echo '<script src="spinner.js"></script>';
	...
	echo 'Poligon zaključen.<br><br>SEDAJ ZAPRITE BRSKALNIK<br><br>Hvala za sodelovanje!';
